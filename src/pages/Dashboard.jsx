    ...
    <div className="bg-gray-900 min-h-screen text-white">
      ...
      <nav className="bg-gray-800 fixed top-0 z-10 w-full p-4 flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          />
          <div className="hidden sm:block text-lg">John's boutique</div>
        </div>
        <div className="flex items-center space-x-4">
          <button className="text-white hover:text-purple-500">
            <img src={truckimg} alt="" className="h-10" />
          </button>
          <button className="text-white hover:text-purple-500">
            <img src={gearimg} alt="" className="h-10" />
          </button>
        </div>
      </nav>
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          ...
          {/* Add Product Card */}
          <div className="bg-gray-800 h-80 p-4 rounded-lg shadow-lg hover:scale-110 flex flex-col items-center justify-center cursor-pointer hover:shadow-2xl transition duration-300">
